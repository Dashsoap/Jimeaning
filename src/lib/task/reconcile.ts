...
/**
 * Find tasks stuck in "running" with stale heartbeats and mark them failed.
 */
...
/**
 * Find tasks that are "running" but have NO heartbeat at all (never started properly).
 * These are orphans from a crash before the first heartbeat.
 * Grace period: only if created more than graceMs ago.
 */
